...
/**
 * The signed-in half of `/`, rendered only once page.tsx has resolved a session
 * on the server. It stays a client component: every branch below depends on
 * Convex queries and Clerk state that must live in the browser.
 *
 * Signed-out visitors never reach this file, so none of these hooks mount and no
 * Convex query fires for them.
 */
